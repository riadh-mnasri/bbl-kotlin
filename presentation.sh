    ...
    read
    echo -e -n "${CHECK_MARK} 1. Kotlin is not an innovation"
    read
    ...
    echo -e -n "${CHECK_MARK} 2. Kotlin solves a lot of Java problems"
    read
    echo -e -n "     \033[3m- Clear and attractive syntax"
    read
    echo -e -n "     - Null Safety"
    read
    echo -e -n "     - Immutability"
    read
    echo -e -n "     - Functional programming paradigm"
    read
    echo -e -n "     - Enhanced Collections"
    read
    echo -e -n "     - Extension functions"
    read
    echo -e -n "     - Delegation"
    read
    echo -e -n "     - Etc ..."
